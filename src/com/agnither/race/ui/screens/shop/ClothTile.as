...
import com.agnither.race.ui.screens.shop.ClothesTab;
...
public class ClothTile extends AbstractView {

    public static const BUY_CLOTH: String = "buy_cloth_ClothTile";

    private var _value: ClothVO;
    ...
    public function ClothTile(refs: CommonRefs, value: ClothVO) {
        _value = value;
    ...
    private function buy():void {
        if (!ClothesTab.swipe) {
            dispatchEventWith(BUY_CLOTH, true, _value);
        }
    }
}
}
